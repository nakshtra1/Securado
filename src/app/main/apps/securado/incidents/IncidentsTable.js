...
import IncidentsTableHead from './IncientsTableHead'
            ...
            {_.orderBy(
              ...
              .map((n,index) => {
                ...
                return (
                  ...
                  >
                    <TableCell  className="p-4 md:p-16 "   scope="row" align="right">
                      {n.name}
                    </TableCell>
                    <TableCell className="p-4 md:p-16 truncate"  component="th" align="right" scope="row">
                      {n.categories.join(', ')}
                    </TableCell>
                    <TableCell className="p-4 md:p-16" component="th" align="right"  scope="row" >
                      <span>$</span>
                      {n.priceTaxIncl}
                    </TableCell>
                    ...
                    <TableCell  component="th" scope="row" align="right">
                      <span>$</span>
                      {n.priceTaxIncl}
                    </TableCell> <TableCell  component="th" scope="row" align="right">
                      <span>$</span>
                      {n.priceTaxIncl}
                    </TableCell> <TableCell  component="th" scope="row" align="right">
                      <span>$</span>
